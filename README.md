...
- The provider demo seeds the normal tenant/billing/report tables and exercises
  the same provider console and workspace-scoped support sessions used by a
  production `/provider` installation, while keeping all demo writes disabled
