...
DELIVERY_EVENTS_WRITE_SCOPE = "delivery-events:write"
...
DELIVERY_EVENT_SCOPES = {DELIVERY_EVENTS_WRITE_SCOPE}
ALL_API_TOKEN_SCOPES = PUBLIC_READ_SCOPES | PROVIDER_SCOPES | SCIM_SCOPES | DELIVERY_EVENT_SCOPES
